...
const Banner = () => {
  return (
    <div className="h-full from-green-50 pb-1">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 lg:gap-4">
          <div className="relative">
            <Image
              ...
              width={200}
              height={200}
              className="w-4 h-4 sm:w-8 sm:h-8 md:w-12 md:h-12 lg:w-16 lg:h-16 flex-shrink-0 rounded-lg"
            />
          </div>
          <div>
  ...
  return (
    <Card className="w-full h-full flex-grow min-w-0 rounded-none shadow-none flex flex-col p-0">
      <CardHeader className="flex-shrink-0 flex-basis-1/3 border-b-2 border-green-600 from-green-50 px-6 py-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 lg:gap-4 mb-2">
            <div className="relative">
              <Image
                ...
                width={500}
                height={500}
                className="w-4 h-4 sm:w-8 sm:h-8 md:w-12 md:h-12 lg:w-16 lg:h-16 xl:w-20 xl:h-20 2xl:w-24 2xl:h-24 flex-shrink-0 rounded-lg"
              />
            </div>
            <div>
              ...
              <h2 className="text-center font-black text-green-800 text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl leading-tight rounded-lg">
                CỔNG THÔNG TIN ĐIỆN TỬ BVĐK LÊ NGỌC TÙNG TRÊN ZALO
              </h2>
            </div>
          </div>
          ...
          <div className="flex-1 order-1 lg:order-2 flex flex-col justify-center relative min-w-0">
            <div className="relative">
              <p className="absolute -top-3 sm:-top-0 lg:-top-0 left-1/2 transform -translate-x-1/2 z-10 text-center font-black text-red-700 text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl">
                <span className="bg-white border-2 border-green-600 px-3 py-2 rounded-lg shadow-lg">
                  TÍNH NĂNG
                </span>
              </p>
