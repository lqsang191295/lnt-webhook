  ...
  return (
    <>
      ...
      <Dialog open={index !== null} onOpenChange={(v) => !v && close()}>
        <DialogContent
          className="w-full h-full p-4 grid-rows-[auto_1fr] [&>button.absolute.top-4.right-4]:hidden z-50"
          style={{ maxWidth: "unset", background: "#00000050", zIndex: 1000 }}>
          <div className="flex flex-row justify-center">
            <div className="font-medium truncate text-white text-xl">
